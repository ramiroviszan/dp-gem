...
from classifier_result import ClassifierResult


class DeepLogLMClassifier:

    def __init__(self, experiment, datasets_params, network_fullpath, network_params, classifier_params, outputs):
        ...
        val_results_fullpath = outputs['results_fullpath'].format(exp_name=self.exp_name, dataset_type='val')
        test_results_fullpath = outputs['results_fullpath'].format(exp_name=self.exp_name, dataset_type='test')
        self.val_results = ClassifierResult(val_results_fullpath, results_header)
        self.test_results = ClassifierResult(test_results_fullpath, results_header)
